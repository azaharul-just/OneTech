                 ...
                 <div class="col-lg-5 " style=" padding: 20px;">
                    <div class="contact_form_container">
                        ...
                        <form action="{{ route('payment.process') }}" id="contact_form" method="post">
                           ...
                           <div class="form-group">
                                <ul class="logos_list " style="margin-left: 100px;">
                                            <li><input type="radio" name="payment" value="cash">Cash</li>
                                            <li><input type="radio" name="payment" value="stripe"> <img src="{{ asset('public/frontend/images/logos_1.png') }}" style="width: 60px; height: 40px;"></li>
                                            <li><input type="radio" name="payment" value="paypal"> <img src="{{ asset('public/frontend/images/logos_2.png') }}" style="width: 60px;"></li>
                                             <li><input type="radio" name="payment" value="ideal"> <img src="{{ asset('public/frontend/images/logos_3.png') }}" style="width: 60px; height: 40px;"></li>
                                 </ul>
                            </div><br>
