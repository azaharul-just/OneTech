            ...
            <div class="row">
                   ...
                   <tbody>
                    @foreach($order as $row)
                     <tr>
                       ...
                       <td>
                       	@if($row->return_order == 0)
                         <a href="{{ url('/request/return/'.$row->id) }}" class="btn btn-sm btn-danger" id=" ">Return</a>
                         @elseif($row->return_order == 1)
		                       	<span class="badge badge-info">Pending</span>
		                 @elseif($row->return_order == 2) 
		                       	 <span class="badge badge-info">Success </span>
               ...
               <div class="col-4">
                 <div class="card" style="width: 18rem;">
                  <img src="{{ asset('public/team-2.jpg') }}" class="card-img-top" style="height: 90px; width: 90px;border-radius: 50%; margin-left: 34%;" >
                  <div class="card-body">
