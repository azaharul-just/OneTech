								...
								<li class="cart_item clearfix">
									...
									<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
										...
										<div class="cart_item_total cart_info_col">
											...
											<a href="{{URL::to('add/to/cart/'.$row->id)}}" class="btn btn-sm btn-success">Add To Cart</a>
											<a href="{{URL::to('remove/wishlist/'.$row->id)}}" id="delete" class="btn btn-sm btn-danger">Remove</a>
										</div>
									</div>
								</li>
								@endforeach
