            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 char_col">
                    ...
                    <div class="char_item d-flex flex-row align-items-center justify-content-start">
                        ...
                        <div class="char_content">
                            <div class="char_title">Satisfied Delivery</div>
                            <div class="char_subtitle">from $50</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 char_col">
                    <div class="char_item d-flex flex-row align-items-center justify-content-start">
                        ...
                        <div class="char_content">
                            <div class="char_title">Security</div>
                            <div class="char_subtitle">from $50</div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="featured_slider_item">
                                        ...
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            ...
                                            @else
                                             <div class="product_price discount">${{ $row->discount_price }}<span>${{ $row->selling_price }}</span></div>
                                            @endif
                                                <div class="product_name"><div><a href="{{URL::to('product/details/'.$row->id.'/'.$row->product_name)}}">
                                                    {{ $row->product_name }}
                                                </a></div></div>
                                                <div class="product_extras">
                                                     <button id="{{ $row->id }}" class="product_cart_button addcart" data-toggle="modal" data-target="#cartmodal"  onclick="productview(this.id)">Add to Cart</button>
                                ...
                                <div class="trends_item is_new">
                                    ...
                                    <div class="trends_content">
                                        ...
                                        <div class="trends_info clearfix">
                                            <div class="trends_name"><a href="{{URL::to('product/details/'.$row->id.'/'.$row->product_name)}}">{{ $row->product_name }}</a></div><br>
                                            ...
                                            @else
                                             <div class="product_price discount">${{ $row->discount_price }}<span>${{ $row->selling_price }}</span></div>
                                            @endif
                                            <a href="{{URL::to('product/details/'.$row->id.'/'.$row->product_name)}}" class="btn btn-danger btn-sm pull-right">View Product</a>
                ...
                <div class="col">
                    <div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
                        <div class="newsletter_title_container">
                            ...
                            <div class="newsletter_title">Getting Offer </div>
