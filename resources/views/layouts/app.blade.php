            ...
            <div class="row">
                ...
                <div class="col-lg-2 offset-lg-2">
                    <div class="footer_column">
                        <div class="footer_title">Latest Category</div>
                        @php
                            $newcat = DB::table('categories')->orderBy('id','DESC')->limit(5)->get();
                            $newbrand = DB::table('brands')->orderBy('id','DESC')->limit(5)->get();
                        @endphp 
                        <ul class="footer_list">
                            @foreach($newcat as $row)
                ...
                <div class="col-lg-2">
                    <div class="footer_column">
                        <div class="footer_title">Latest Brands</div> 
                        <ul class="footer_list">
                            @foreach($newbrand as $row)
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://www.facebook.com/ahappyboy" target="_blank">Asik</a>
