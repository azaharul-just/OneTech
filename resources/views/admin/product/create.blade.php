  ...
  <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
          <div class="card pd-20 pd-sm-40">
            <h6 class="card-body-title">Product Add Form
            ...
            <form action="{{route('store.product')}}" method="post" enctype="multipart/form-data">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="product_quantity" value=" " placeholder="Enter email address">
                </div>
              </div><!-- col-4 -->
        ...
        <hr>
            ...
            <div class="form-layout-footer">
              <button class="btn btn-info mg-r-5" type="submit">Save Product</button> 
...
<!-- Multiple tag inputs js file link added -->
