    ...
    <div class="sl-sideleft"> 
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
           ...
           <li class="nav-item"><a href="{{ route('today.payment_accept') }}" class="nav-link">Today Payment Accept</a></li>
          <li class="nav-item"><a href="{{ route('today.delevered') }}" class="nav-link">Today Delevered</a></li> 
           <li class="nav-item"><a href="{{ route('this.month') }}" class="nav-link">This Month Delevered</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="{{ route('create.user.role') }}" class="nav-link">All Admins</a></li>
        </ul>
         @else
        @endif
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name">{{Auth::user()->email}}</span>
